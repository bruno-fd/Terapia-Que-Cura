...
export default function Cadastro() {
  ...
  // CTAs gerais levam ao funil sem plano pré-selecionado: a escolha de plano
  // acontece normalmente na Etapa 3 do funil.
  const irParaFluxo = () => {
    setLocation("/cadastro/fluxo");
  };

  // Botões dos cards de plano: já levam o plano escolhido para o funil, que
  // pula a Etapa 3 e segue direto para conta e pagamento.
  const escolherPlano = (plano: "mensal" | "anual") => {
    setLocation(`/cadastro/fluxo?plano=${plano}`);
  };
