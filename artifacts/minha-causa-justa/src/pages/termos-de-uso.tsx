        ...
        <div className="container mx-auto px-6 max-w-[800px] py-16 md:py-24">
          ...
          <article className="prose prose-neutral max-w-none">
            ...
            <p className="text-lg text-neutral-700 leading-relaxed mb-8">
              Bem-vindo à Minha Causa Justa. Antes de usar a plataforma, leia com atenção o que
              está escrito aqui. A ideia é ser direto e claro, sem juridiquês desnecessário.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-10">
              Ao acessar ou usar o site minhacausajusta.com.br, você concorda com tudo que está
            ...
            <h2 className="text-2xl font-bold text-primary-900 mt-12 mb-4">
              O que é a Minha Causa Justa
            </h2>
            <p className="text-neutral-700 leading-relaxed mb-6">
              A Minha Causa Justa é uma plataforma de divulgação de advogados. Funcionamos como
              um diretório: reunimos perfis de advogados em diferentes áreas e estados, e
              publicamos conteúdo informativo sobre direitos do cidadão.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-6">
              Não somos um escritório de advocacia. Não prestamos serviços jurídicos. Não
              indicamos, recomendamos nem garantimos nenhum profissional listado na plataforma.
              Não participamos de nenhuma negociação entre você e o advogado que escolher
              contatar.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-10">
              O conteúdo que publicamos – artigos, textos informativos, explicações sobre
              direitos – tem finalidade exclusivamente educativa. Não é aconselhamento
              jurídico. Para qualquer decisão legal, consulte um advogado.
            </p>
            ...
            <p className="text-neutral-700 leading-relaxed mb-6">
              ...
              perfis de advogados sem precisar se cadastrar.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-6">
            ...
            <p className="text-neutral-700 leading-relaxed mb-6">
              A decisão de entrar em contato com qualquer advogado listado aqui é inteiramente
              sua. O contato é feito diretamente entre você e o profissional – a Minha Causa
              Justa não participa dessa conversa.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-10">
              Qualquer relação que você estabeleça com um advogado encontrado nesta plataforma
              é de responsabilidade exclusiva de vocês dois. Não respondemos por honorários,
              acordos, resultados ou qualquer problema que possa surgir dessa relação.
            </p>

            <h2 className="text-2xl font-bold text-primary-900 mt-12 mb-4">
              Para advogados cadastrados
            </h2>
            <p className="text-neutral-700 leading-relaxed mb-6">
              O cadastro na plataforma é exclusivo para advogados com inscrição ativa na Ordem
            ...
            <ul className="list-disc pl-6 space-y-2 text-neutral-700 leading-relaxed mb-6">
              <li>Sua inscrição na OAB está ativa e regular</li>
              <li>Todas as informações fornecidas são verdadeiras e atualizadas</li>
              <li>
                Está ciente das normas do Código de Ética e Disciplina da OAB e do Provimento
                205/2021 do Conselho Federal
              </li>
              <li>
            ...
            <p className="text-neutral-700 leading-relaxed mb-6">
              Verificamos automaticamente sua situação na OAB por meio do sistema público do
              Conselho Federal. O perfil só é ativado após confirmação de inscrição ativa.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-6">
              Você é o único responsável pelo conteúdo do seu perfil e por mantê-lo atualizado.
              Se sua situação na OAB mudar – suspensão, cassação ou qualquer irregularidade –
              você deve nos avisar imediatamente pelo e-mail{" "}
              <a
                href="mailto:contato@minhacausajusta.com.br"
                className="text-primary-600 hover:underline"
              >
                contato@minhacausajusta.com.br
              </a>
              .
            </p>
            <p className="text-neutral-700 leading-relaxed mb-6">
            ...
            <ul className="list-disc pl-6 space-y-2 text-neutral-700 leading-relaxed mb-6">
              ...
              <li>
                Utilizar a plataforma de qualquer forma que contrarie o Código de Ética da OAB
                ou a legislação brasileira
              </li>
            </ul>
            <p className="text-neutral-700 leading-relaxed mb-10">
              Você é inteiramente responsável pelos tributos sobre os serviços que prestar aos
              seus clientes. A Minha Causa Justa não tem nenhuma responsabilidade tributária
              sobre isso.
            </p>
            ...
            <p className="text-neutral-700 leading-relaxed mb-6">
              ...
              terceiros, leis ou normas da OAB.
            </p>
            <p className="text-neutral-700 leading-relaxed mb-10">
              Se qualquer conteúdo publicado por você causar dano à Minha Causa Justa ou a
            ...
            <p className="text-neutral-700 leading-relaxed mb-10">
              Ao se cadastrar, você autoriza a Minha Causa Justa a enviar comunicações
            ...
            <p className="text-neutral-700 leading-relaxed mb-10">
              ...
              em contato com a Minha Causa Justa, sua conta será suspensa automaticamente até a
            ...
            <p className="text-neutral-700 leading-relaxed mb-6">
              ...
              Minha Causa Justa são de nossa propriedade. Você não pode reproduzir, copiar,
            ...
            <ul className="list-disc pl-6 space-y-2 text-neutral-700 leading-relaxed mb-6">
              <li>
                Não garantimos a veracidade das informações inseridas pelos advogados em seus
                perfis
              </li>
              <li>
            ...
            <p className="text-neutral-700 leading-relaxed mb-10">
              ...
              responsabilidade, nossa obrigação fica limitada ao valor pago pelo advogado nos
            ...
            <p className="text-neutral-700 leading-relaxed mb-10">
              ...
              antiéticos, perca a habilitação profissional na OAB, ou seja alvo de determinação
            ...
            <p className="text-neutral-700 leading-relaxed mb-10">
              ...
              relevantes, avisaremos os advogados cadastrados por e-mail com antecedência
